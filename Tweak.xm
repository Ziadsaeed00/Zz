...
void showAlert(NSString *title, NSString *message) {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        // جلب الواجهة النشطة عبر نافذة التطبيق الأساسية بطريقة متوافقة
        ...
        // إذا لم يجد النافذة بالطريقة الحديثة، يستعين بالنافذة الافتراضية للـ Delegate
        ...
        // إظهار التنبيه فوق أعلى واجهة معروضة حالياً
        if (rootVC) {
